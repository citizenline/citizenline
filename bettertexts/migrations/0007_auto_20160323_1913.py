    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=models.deletion.CASCADE, related_name='content_type_set_for_textcomment', to='contenttypes.ContentType', verbose_name='content type')),
                ('site', models.ForeignKey(on_delete=models.deletion.CASCADE, to='sites.Site')),
                ('user', models.ForeignKey(on_delete=models.deletion.CASCADE, null=True, blank=True, verbose_name='user', related_name='textcomment_comments', to=settings.AUTH_USER_MODEL)),
            ],
            options={

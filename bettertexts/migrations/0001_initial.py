    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.PositiveIntegerField(default=0)),
                ('question', models.ForeignKey(on_delete=models.deletion.CASCADE, to='bettertexts.Question')),
            ],
        ),
        migrations.CreateModel(
            name='Text',
            fields=[
                ...
                ('site', models.ForeignKey(on_delete=models.deletion.CASCADE, to='sites.Site', editable=False, default=1)),
            ],
            options={
                'verbose_name': 'tekst',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(on_delete=models.deletion.CASCADE, to='sites.Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.ForeignKey(on_delete=models.deletion.CASCADE, related_name='user_ratings', to='bettertexts.Rating')),
            ],
        ),
        migrations.AddField(
            model_name='text',
            name='type',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE, to='bettertexts.Type'),
        ),
        migrations.AddField(
            model_name='rating',
            name='text',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE, to='bettertexts.Text'),
        ),
        migrations.AddField(
            model_name='question',
            name='type',
